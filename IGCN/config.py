...
def get_amazon_config(device):
    dataset_config = {'name': 'ProcessedDataset', 'path': '/content/kg-recsys/IGCN/data/Amazon/time',
                      'device': device}
    amazon_config = []
...
def get_movielens_config(device):
    dataset_config = {'name': 'ProcessedDataset', 'path': '/content/kg-recsys/IGCN/data/Movielens/time',
                      'device': device}
    movielens_config = []

    model_config = {'name': 'MF', 'embedding_size': 64, 'device': device}
    trainer_config = {'name': 'BPRTrainer', 'optimizer': 'Adam', 'lr': 1.e-3, 'l2_reg': 1.e-4,
                      'device': device, 'n_epochs': 10, 'batch_size': 2048, 'dataloader_num_workers': 6,
                      'test_batch_size': 512, 'topks': [20]}
    movielens_config.append((dataset_config, model_config, trainer_config))
    ...
    model_config = {'name': 'MultiVAE', 'layer_sizes': [64, 32],
                    'device': device, 'dropout': 0.7}
    trainer_config = {'name': 'MLTrainer', 'optimizer': 'Adam', 'lr': 1.e-3, 'l2_reg': 1.e-5, 'kl_reg': 0.2,
                      'device': device, 'n_epochs': 10, 'batch_size': 512, 'dataloader_num_workers': 6,
                      'test_batch_size': 512, 'topks': [20]}
    movielens_config.append((dataset_config, model_config, trainer_config))
