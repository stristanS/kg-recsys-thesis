...
print('test_u_indices, test_v_indices', len(set(test_u_indices)), len(set(test_v_indices)))
...
# print('1111111111111', train_indices)
...
# print('1111111111111', len(test_indices[0]))
print('eval(dataset_class)', eval(dataset_class))
...
if not args.no_train:
    ...
    eval_model(test_dataset= test_graphs, test_indices =test_indices, batch_size =args.batch_size, regression=False, ARR=args.ARR,
          show_progress=True, epoch=None, k = 20, test_file_path = None)
