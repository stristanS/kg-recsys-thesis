...
def load_rating(args):
    ...
    # reading rating file
    rating_file = '../data/' + args.dataset + '/ratings_final_train'
    ...
    train_data = np.loadtxt('/content/KGCN/data/movie/ratings_final_train.txt', dtype=np.int64)
    eval_data = np.loadtxt('/content/KGCN/data/movie/ratings_final_val.txt', dtype=np.int64)
    test_data = np.loadtxt('/content/KGCN/data/movie/ratings_final_test.txt', dtype=np.int64)
